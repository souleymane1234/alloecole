...
import { Play, Volume2, Maximize, Share2, Heart, Download, Clock, Eye } from 'lucide-react';
...
const WebTVHero = () => {
  ...
  const featuredVideo = {
    ...
    thumbnail: "/assets/images/poster/poster.jpg",
                ...
                <div className="video-controls">
                  ...
                  <div className="control-buttons">
                    ...
                    <button className="control-button" onClick={handleLike}>
                      <Heart size={16} style={{ color: isLiked ? '#ef4444' : 'white' }} />
                    </button>
                    <button className="control-button">
                      <Download size={16} />
                    </button>
