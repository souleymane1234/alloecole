...
const AlloEcoleBourses = () => {
  ...
  return (
    <section className="bourses-section py-5 bg-light">
      <div className="container">
        <div className="row">
          <div className="col-lg-8 mx-auto text-center mb-5">
            <h2 className="section-title">Bourses d'études</h2>
        ...
        <div className="row mb-4">
          <div className="col-12">
            <div className="bourses-tabs d-flex justify-content-center">
        ...
        <div className="row g-4">
          {displayedBourses.length > 0 ? (
            displayedBourses.map((bourse) => (
              <div key={bourse.id} className="col-lg-4 col-md-6">
                <div className={`bourse-card h-100 ${bourse.status === 'past' ? 'past-bourse' : ''}`}>
        ...
        <div className="row mt-5">
          <div className="col-12">
            <div className="bourses-stats bg-white p-4 rounded shadow-sm">
